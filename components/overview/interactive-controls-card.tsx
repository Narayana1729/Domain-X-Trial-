...
import { Sliders, RefreshCw, Zap, Power, AlertOctagon } from "lucide-react"
  ...
  return (
    <div className="bg-[#1B1B1B] border border-[#2A2A2A] rounded-lg p-6 space-y-5">
      ...
      <div className="space-y-4">
        ...
        {/* Live Auto-Polling & Emergency Motor Toggle */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="flex items-center justify-between p-3 bg-[#121212] rounded-lg border border-[#2A2A2A]">
            <div className="flex items-center gap-2">
              <Zap className="h-4 w-4 text-[#FF6B00]" />
              <div>
                <span className="text-xs font-semibold text-[#EDEDED] block">Live Polling</span>
                <span className="text-[11px] text-[#9A9A9A]">2s Stream</span>
              </div>
            </div>
            <button
          ...
          <div className="flex items-center justify-between p-3 bg-[#121212] rounded-lg border border-[#2A2A2A]">
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="text-xs font-semibold text-[#EDEDED] block">Motor Control</span>
                <span className="text-[11px] text-[#9A9A9A]">L298N ENA Pin</span>
              </div>
            </div>
            <button
